...
#ifdef CC26XX_WEB_DEMO_CONF_DIGITAL
#define CC26XX_WEB_DEMO_DIGITAL CC26XX_WEB_DEMO_CONF_DIGITAL
#else
#define CC26XX_WEB_DEMO_DIGITAL 1
#endif
/*---------------------------------------------------------------------------*/
...
#define CC26XX_WEB_DEMO_SENSOR_DIGITAL        17
/*---------------------------------------------------------------------------*/
