...
This application v1.4 enables communication for sensors/button reading and Devices activation through 6lowpan/CoAP protocols between a “6lbr-Slip-radio” (i.e. a router device) and a “cc26xx-web-demo” device. This Repository contains all files to operate and build the firmware for X.IP4T and X.IP5 devices.
...
Find this and other projects on Hackster.io:: http://bit.ly/2nCfOuc
